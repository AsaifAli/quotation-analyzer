...
class LLMProvider:
    ...
    def _openai(self, prompt: str, system: str, temperature: float,
        ...
        gateway_url = (config.LLM_GATEWAY_URL or config.LLM_BASE_URL or (config.OPENAI_BASE_URL if "portfolio-llm-gateway.onrender.com" in config.OPENAI_BASE_URL.lower() else "")).strip()
