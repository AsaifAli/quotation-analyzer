...
class QuotationIntelligenceAgent:
    def __init__(self,provider:Optional[str]=None): self.llm=LLMProvider(provider); self.processor=DocumentProcessor(); self.web_search=WebSearch(); self.state=AgentState()
